    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="7days-diet-plan.php">Day List</a></li>
                            ...
                            <div class="card mb-3 food-card">
                                <div class="card-body food-content">
                                    <div class="flex-container">
                                        <img src="https://static.toiimg.com/thumb/88520288.cms?width=280&height=200" alt="Food Image" class="card-img">
                                        <div class="flex-item">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="info-modal-label">Food Details</h5>
