          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4 week">
                <div class="card">
                  <div class="card-body">
                    <a href="7days-workout-plan_no_header.php?id=2"><h5 class="card-title">Week 2</h5></a>
            ...
            <div class="row">
              <div class="col-md-4 week">
                <div class="card previous-week-card"> <!-- Add a class to distinguish previous week card -->
                  <div class="card-body">
                    <a href="7days-workout-plan_no_header.php?id=1"><h5 class="card-title">Week 1</h5></a>
