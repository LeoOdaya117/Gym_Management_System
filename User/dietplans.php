      ...
      <div clas="holder">
        <div class="card">
          <div class="card-header bg-dark">
            <h2 class="text-center mb-0">Diet Plans</h2>
          </div>
          <div class="card-body">
            <div class="current-week mt-3">Current Diet Plan:</div>
            ...
            <div class="row">
              <div class="col-md-4 week">
                <div class="card">
                  <div class="card-body">
                    <a href="7days-diet-plan.php?id=2"><h5 class="card-title">Week 2</h5></a>
            ...
            <div class="row">
              <div class="col-md-4 week">
                <div class="card previous-week-card"> <!-- Add a class to distinguish previous week card -->
                  <div class="card-body">
                    <a href="7days-diet-plan.php?id=1"><h5 class="card-title">Week 1</h5></a>
