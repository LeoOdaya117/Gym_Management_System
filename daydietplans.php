...
<body>
  ...
  <div class="holder">
    <div class="card">
      <div class="card-header bg-dark">
        <h2 class="text-center mb-0">Day 1 Food</h2>
      </div>
      <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4 day">
                <div class="card mb-3 exercise-card">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="https://static.toiimg.com/thumb/88520288.cms?width=280&height=200" alt="Exercise 1">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body exercise-content">
                                ...
                                <p class="card-text d-block">
                                    <small class="text-body-secondary">Serving: 10</small> 
  ...
  <script>
    function goBack(){
      window.location.href = "weekdietplans.php";
