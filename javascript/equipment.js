        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({ 
                    ...
                    url: 'admin/api/save_equipment.php', 
                    method: 'POST', 
                    data: formData, 
                    processData: false, 
                    contentType: false, 
    ...
    $('#example').on('click', '.delete-button', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "delete.php", // Replace with the actual PHP file to handle the saving logic
                    data: {
        ...
        buttons: [
            ...
            },
            {
                ...
                filename: function() {
                    ...
                    return 'ListOfEquipments_' + formattedDate + currentTime;
                },
                exportOptions: {
                    columns: [0, 1, 2]
                }
            ...
            },
            {
                ...
                filename: function() {
                    ...
                    return 'ListOfEquipments' + formattedDate + currentTime;
                },
                exportOptions: {
                    columns: [0, 1, 2]
                }
